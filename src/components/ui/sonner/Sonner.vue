...
const props = defineProps({
  ...
  position: { type: String, required: false }, // union type like 'top-left' | 'top-right' | 'bottom-left' | 'bottom-right' | 'top-center' | 'bottom-center'
...
<template>
  <!-- Type 'string' is not assignable to type 'Position' (union type) -->
  <Sonner 
    class="toaster group"
    v-bind="props"
    :toast-options="{
